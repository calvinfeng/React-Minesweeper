...
/***/ function(module, exports, __webpack_require__) {
	...
	var Minesweeper = __webpack_require__(167),
	    React = __webpack_require__(1),
	    Board = __webpack_require__(168);
	  ...
	  render: function () {
	    ...
	    this.props.board.grid.forEach(function (row, i) {
	      var mapRow = row.map(function (sq) {
	        ...
	        return React.createElement(Tile, { tileObject: sq, callback: self.props.callback });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = React.createClass({
	  ...
	  render: function () {
	    ...
	    if (tile.explored) {
	      if (tile.bombed) {
	        div = React.createElement(
	          'div',
	          { className: 'bombed' },
	          React.createElement('img', { src: './imgs/bomb.png' })
	        );
	      } else {
	        div = React.createElement(
	          'div',
	      ...
	      div = React.createElement(
	        'div',
	        { className: 'flagged' },
	        React.createElement('img', { src: './imgs/flag.png' })
	      );
	    } else {
	      div = React.createElement(
	        'div',
	    ...
	    return React.createElement(
	      'li',
	      { className: 'sq', onClick: this.handleClick },
	      div
	    );
	  }
	});
